...
class AgentHelper(object):
    ...
    def __init__(self, agent_config, network, service, sim_config, seed, episodes, weights, verbose,
        ...
        # Initialize config_dir and weights_path here to ensure they are set correctly
        self.config_dir = f"./results/{self.experiment_id}/"
        self.weights_path = f"{self.config_dir}/weights"
